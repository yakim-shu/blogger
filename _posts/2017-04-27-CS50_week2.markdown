...
![組合語言-w500](https://i.imgur.com/TrbBRx9.png){:width="500"}
...
![linking-w500](https://i.imgur.com/cSzO2LL.png){:width="500"}
...
![記憶體空間-w400](https://i.imgur.com/RJpWf2f.png){:width="400"}
...
![存長度在變數-w400](https://i.imgur.com/02IqpZf.png){:width="400"}
...
![Zamyla-w450](http://i.imgur.com/oNmzdt8.png){:width="450"}

假如再加入另一個的字串 ``Andi``，那電腦要如何得知這它們之間的斷點呢?

所以在結束一個字串後，會自動加上 **``\0``** 的字元，當做此字串的結束。

![Zamyla&Andi-w450](http://i.imgur.com/ag930Yh.png){:width="450"}
...
![加密-w500](http://i.imgur.com/KLyoxPR.png){:width="500"}

反過來說，你拿到一段加密後的資料，只要有正確的金鑰，就可以還原成原始資料。

還記的 [week 0 提到的 ASCII](CS50_week0.html) 嗎?

![ASCII-w500](http://i.imgur.com/d7sie6T.png){:width="500"}
...
![加密 - step1-w350](https://i.imgur.com/epvw5Hv.png){:width="350"}

> 示愛第二步：把訊息轉成 ASCII 碼，會得到以下數字

![加密 - step2-w350](https://i.imgur.com/z5KT2FC.png){:width="350"}

> 示愛第三步：想辦法加密，深怕愛到一個笨蛋，就簡單的就每個數字都 + 1

![加密 - step3-w350](https://i.imgur.com/kDy3Eks.png){:width="350"}

> 示愛第四步：再把我們加密過後的訊息轉回字元

![加密 - step4-w350](https://i.imgur.com/0eIl8pH.png){:width="350"}
...
![錯誤代碼-w600](https://i.imgur.com/GVTXt03.png){:width="600"}

---

## 排序法 Sorting

![排序法](https://i.imgur.com/fyYSDFn.png)
...
方法：比較相鄰兩值，進行交換
 ...
 ![Bubble Sort](https://i.imgur.com/itnN9Ui.png)
...
![Selection Sort](https://i.imgur.com/H8gogRF.png)
...
![Merge Sort-w500](https://i.imgur.com/efsjejn.png){:width="500"}
...
![n平方-w300](https://i.imgur.com/4SMtRq0.png){:width="300"}

> 而合併排序的效率是更好了，時間複雜度為 `n * log(n)`

![時間複雜度-w350](https://i.imgur.com/4DaCHOz.png){:width="350"}
...
![Apr-07-2019 15-56-53](https://i.imgur.com/WPxq5w6.gif)
