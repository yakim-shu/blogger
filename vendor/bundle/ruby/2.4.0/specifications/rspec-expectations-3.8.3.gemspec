# -*- encoding: utf-8 -*-
# stub: rspec-expectations 3.8.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-expectations-3.8.3".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.8.0"])
      ...
      s.add_dependency(%q<rspec-support>.freeze, ["~> 3.8.0"])
